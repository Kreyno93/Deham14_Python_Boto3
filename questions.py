...
def ask_create_instance():
    ...
    if response in ["yes", "y"]:
        ...
        list_subnets()
        subnet_id = input("Enter the subnet id you want to create: ").strip()
        list_sgs()
        sg_id = input("Enter the security group id you want to create: ").strip()
        create_instance(instance_name,subnet_id,sg_id)
    else:
